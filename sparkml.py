...
iq_df = spark.sql("SELECT test1, test2, test3, test4, final_score FROM gradesml")
...
assembler = VectorAssembler(
    inputCols=["literacy_rate", "nobel_prices", "hdi_2021", "mean_years_schooling_2021","gni_2021", "population_2023", "average_iq"],
    outputCol="features",
